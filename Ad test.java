...
//              	      operation.setOperand(responsiveAd);
//              	      operation.setOperator(Operator.ADD);
//              	      System.out.println("------3");
//              	      AdGroupAdReturnValue result = adgroupadservice.mutate(new AdGroupAdOperation[] {operation});
//              	      System.out.println("------4");
//              	      System.out.println("returnvalue is " +result);
//              	      for(AdGroupAd adgroupadResult : result.getValue())
//              	      {
//              	    System.out.println("Adgroupad result is "+adgroupadResult);
//              	   newad = (ResponsiveDisplayAd) adgroupadResult.getAd();
//	
//		
//		          JSONParser parser=new JSONParser();
...
//	                    	 
//	                    	 newDocument.put("localId", camp.getLocalId());
//	                    	 newDocument.put("adId", newad.getId());
//	                    	 newDocument.put("adgroup_id", id);
//	                    	 newDocument.put("campaign_Id", camp.getCampaignId());
//	                    	 newDocument.put("budget_id",camp.getBudgetId());
//	     	  				newDocument.put("ad_type", newad.getAdType());
//	    		    		if(newad.getType()!=null){
//	    		    		AdType adtype = newad.getType();
//	    		    		newDocument.put("type", adtype.getValue());
//	    		    		}
//	    		    		newDocument.put("LocalImageId", camp.getCreatAd().getResponsiveAd().getImage());
//	    		    		newDocument.put("mediaId", camp.getMediaId());	
//	    		    		newDocument.put("display_url",newad.getDisplayUrl());
//	    		    		newDocument.put("description1",newad.getDescription());
//	    		    		newDocument.put("Url",newad.getUrl());
//	    		    		newDocument.put("DevicePreference",newad.getDevicePreference());
//	    		    		newDocument.put("FinalURL",newad.getFinalUrls());
//	    		    		newDocument.put("ShortHeadline",newad.getShortHeadline());
//	    		    		newDocument.put("LongHeadline",newad.getLongHeadline());
//	    		    		newDocument.put("ImagePath", path+camp.getCreatAd().getResponsiveAd().getImage());
//	    		    		BasicDBObject searchQuery = new BasicDBObject().append("adId",camp.getAdId());
//		    				campaign_collection.update(searchQuery, newDocument); 
//	     	                System.out.println("end of the mongo");
//		    				
//	     	            }
//	     	            
//
